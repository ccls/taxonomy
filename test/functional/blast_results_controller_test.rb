...
#			post :create, blast_result: { accession: @blast_result.accession, bitscore: @blast_result.bitscore, expect: @blast_result.expect, gaps: @blast_result.gaps, gaps_percent: @blast_result.gaps_percent, identities: @blast_result.identities, identities_percent: @blast_result.identities_percent, score: @blast_result.score, strand: @blast_result.strand }
#		end
#
