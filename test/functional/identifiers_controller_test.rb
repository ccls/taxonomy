...
#      post :create, identifier: { accession: @identifier.accession, gi: @identifier.gi, taxid: @identifier.taxid }
#    end
#
...
#    put :update, id: @identifier, identifier: { accession: @identifier.accession, gi: @identifier.gi, taxid: @identifier.taxid }
#    assert_redirected_to identifier_path(assigns(:identifier))
#  end
#
