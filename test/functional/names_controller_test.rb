...
#      post :create, name: { name_class: @name.name_class, name_txt: @name.name_txt, name_unique: @name.name_unique, taxid: @name.taxid }
#    end
#
...
#    put :update, id: @name, name: { name_class: @name.name_class, name_txt: @name.name_txt, name_unique: @name.name_unique, taxid: @name.taxid }
#    assert_redirected_to name_path(assigns(:name))
#  end
#
