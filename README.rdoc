...
Yet, there is no extract accesion number 3IZT, but there are 3IZT_A and 3IZT_B.
...
> blastdbcmd -db /Volumes/cube/working/indexes/nt -entry all -outfmt '%a,%g,%T' -out accessions_gi_taxid.csv
